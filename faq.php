            ...
            <div class="row">
                <div class="col">
                    <figure class="text-center">
                        ...
                        <p class="lead">Para dar respuesta a preguntas hechas por los clientes hicimos esta sección de preguntas frecuentes</p>
                        <br>
                        <h6>¿Son vehiculos nuevos?</h6>
                        <p>No, son vehiculos usados por otras personas, pero con la condicion de que tienen limite en Kilometraje y estan semi nuevos</p>
                        <br>
                        <h6>¿Es confiable?</h6>
                        <p>Claro que puedes confiar con nosotros</p>
                    </figure>
                </div>
            </div>
        </div>
