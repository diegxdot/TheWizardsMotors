...
<head>
    ...
    <title>Ingresa - Wizards Motors</title>
           ...
           <div class="row my-3">
               ...
               <div class="col-sm-4">
                   <form action="lib/validar_login.php">
                       <input class="form-control my-2" name="correo" placeholder="correo" type="email" required>
                       <input class="form-control my-2" name="contrasena" placeholder="contrasena" type="password" required>
                       <div class="col-sm-2"><button type="submit" value="ingresar" class="btn btn-primary mb-3">Ingresa</button></div>
                       <div class="col-sm-2"><a class="btn btn-secondary" href="registro.html" role="button">Registrate</a></div>
                   </form>
               </div>
               <div class="col-sm-4"></div>
           </div>
